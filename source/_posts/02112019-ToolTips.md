...
let mapleader=","
   """"""""""""""""""""""""""""""
   ""   self defined key begin
   """"""""""""""""""""""""""""""""""
set colorcolumn=90
noremap <leader>t i<Space><C-R>=strftime("\%Y-\%m-\%d \%H:\%M:\%S")<CR><Esc>

nmap <leader>w :up<cr>
noremap <leader>` i```txt<CR>```<Esc>O<Esc>

noremap <C-A> ggVG
vnoremap <C-A> ggVG

  " swap ( and [ key, for lisp things
   " map [ to ()  not working because of paredit
 inoremap [ (
   " map ( to []
 inoremap ( [
inoremap { {}<Esc>i
...
map <leader>f :CtrlPMRU<CR>
    " ctrlp location and file list size
...
let g:ctrlp_custom_ignore = {
    ...
    \ }
    " can use :cd dir to change ctrlp working path
...
set statusline=\ %F%m%r%h\ %w\ \ CWD:\ %r%{getcwd()}%h\ \ \ Line:\ %l\ \ Column:\ %c
   ...
   " post auto change modified time when saved 
...
xcape.
```txt
1. 将上面修改的/etc/defaul/keyboard中的XKBOPTION改为'caps:ctrl_modifier'。(todo: super)

...
echo "Are you sure the local branch is clean? (y/n):"
read XN
...
use this to find out all the commits after yesterday, command like below:
`git log --after="2020-12-15" --pretty=format:"%h%x09%an%x09%ci%x09%s"`
